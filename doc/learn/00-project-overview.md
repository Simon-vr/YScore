...
├── refer/              # 参考资料笔记（CSR/中断/mstatus/链接脚本等）
└── doc/learn/          # 本学习文档
```
...
`rtos/refer/` 收集了本项目学习过程中整理的笔记，可与本文档对照阅读：
CSR.md、mstatus详解.md、中断触发.md、中断处理.md、时钟中断.md、PLIC.md、uart中断.md、
链接脚本语法.md、工具链.md、寄存器规则.md、qemu_virt内存空间.md 等。
