...
本项目的 UART / GPIO **AXI4-Lite 从机外设**（`src/axil_uart.v` / `src/axil_gpio.v`）
移植并适配自 [Z-Core-FPGA](https://github.com/paudiaz99/Z-Core-FPGA)；
处理器核、流水线、存储器、AXI4-Lite 主控、CLINT 与 RTOS 固件均为本项目从零实现（见 [License](#license)）。
...
🌐 **在线阅读：<https://simon-vr.github.io/YScore/>**

📁 文档源码：[docs/learn/](docs/learn/)
...
- [Z-Core-FPGA](https://github.com/paudiaz99/Z-Core-FPGA)：本项目 **UART 与 GPIO 的 AXI4-Lite 从机外设**移植自该项目；处理器核、流水线、存储器、AXI4-Lite 主控、CLINT 与 RTOS 固件均为从零实现。
